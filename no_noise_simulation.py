...
feature_decay=True           # dataset generation parameter which determines w* too
...
plt.title(f'Double Descent in OLS (Trials={num_trials}, No noise)', fontsize=14)
plt.legend()
